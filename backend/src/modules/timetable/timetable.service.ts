...
// Class/section/session are derived from
// the Student profile.
// ============================================
...
//
// Teacher identity comes from JWT.
// teacherId + userId + schoolId are verified.
// ============================================
    ...
    // GET RAW IDS
    //
    // Because sessionId/classId/sectionId
    // are populated, read their _id safely.
    // ========================================
