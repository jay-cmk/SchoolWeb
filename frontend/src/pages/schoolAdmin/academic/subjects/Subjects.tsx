    ...
    async (
      ...
      try {
        ...
        if (
          ...
          showToast(
            "This subject does not belong to the selected academic session"
          );
    ...
    <div className="min-h-screen bg-gray-50 p-5 lg:p-8">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Manage subjects and view class, section and teacher assignments for
            the academic session selected in the topbar.
          </p>
        ...
        <div className="mt-5 flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-amber-700">
              Subjects, assignment summaries and dashboard counts are session-wise.
            </p>
          </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          subtext={
            selectedSession
              ? `Subjects in ${selectedSession.name}`
        ...
        <StatCard
          ...
          subtext={
            selectedSession
              ? `Active periods in ${selectedSession.name}`
              : "Select academic session"
          }
        ...
        <div className="overflow-x-auto">
          ...
          {paginatedSubjects.length ===
            ...
            <div className="p-12 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">
                {selectedSessionId
                  ? "No subject found in the selected academic session."
                  : "Select an academic session from the topbar."}
              </p>
