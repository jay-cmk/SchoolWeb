...
//     { id: 'assignment', label: 'Assighnment', icon: 'lucide:graduation-cap', path: '/school-admin/academic/subject-assignments' },
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-[#E5E7EB] px-5 py-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-base font-bold text-[#15243B]">
                Riverside Academy
              </p>
          ...
          <button
            ...
            className="p-1 text-[#6B7280] hover:text-[#15243B] lg:hidden"
          >
            <Icon
              icon="lucide:x"
              className="text-xl"
        ...
        <div className="shrink-0 border-t border-[#E5E7EB] p-4 text-sm">
          ...
          <button
            ...
            className="flex min-h-11 w-full items-center gap-3 rounded-lg px-3 text-[#6B7280] transition-colors hover:bg-[#F9FAFB] hover:text-[#15243B]"
          >
